                ...
                <form>
                    <div class="mb-6">
                        <label for="name"
                            ...
                            Todo </label>
                        <input wire:model="name" ype="text" id="name" placeholder="Todo.."
                    ...
                    <button type="submit" wire:click.prevent="createTodo"
                    ...
                    @if( session()->has("error"))
                        <span class="text-red-500 text-xs"> {{ session()->get("error") }}</span>
                    @endif
